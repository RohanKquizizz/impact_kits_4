<template>
  <div class="heat-map-container">
    ...
    <!-- Texas outline – filter to approximate Next button #FF319F (mask = square block) -->
    <div class="texas-outline-wrap">
      <div class="texas-outline-inner">
        <img src="/texas-outline.png" alt="Texas" class="texas-outline-img" />
      </div>
    </div>
...
/* Texas outline image – white space between ticker and Oakland card */
.texas-outline-wrap {
  position: relative;
  flex: 1;
  min-height: 0;
...
/* Inner wrapper: 80% so scaled content fits */
.texas-outline-inner {
  position: relative;
  z-index: 1;
  width: 80%;
...
.texas-outline-img {
  ...
  clip-path: inset(5% round 0);
  /* Closest to #FF319F while keeping Texas shape visible */
  filter: hue-rotate(100deg) saturate(1.5) brightness(1.08);
}

/* District Cards – at bottom centre, full width as before */
.district-cards {
  margin-top: auto;
  display: flex;
  justify-content: center;
